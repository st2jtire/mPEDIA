 ...
 <body>
  ...
  <div id="wrap">
	...
	<div class="twoDepthMenu size_5">
		<ul>
			<li class="active"><a href="#none">전체강좌</a></li>
	...
	<div id="contents">
		...
		<div class="courseList">
			<h3><span>중1 내신</span></h3>
			<ul>
				<li><a href="#none">
					<span class="img"><img src="../images/sub/img_course_2.jpg" alt="" /></span>
					<span class="txt">
						<span class="tit">[영어] 중2 – YBM 박</span>
						<span>무료로 누리는 내신의 모든 것</span>
					</span>
					<span class="li">총 12강</span>
					<span class="li">12개월</span>
					<span class="li">정가 : 80,000원</span>
				</a></li>
				<li><a href="#none">
					<span class="img"><img src="../images/sub/img_course_2.jpg" alt="" /></span>
					<span class="txt">
						<span class="tit">[영어] 제목이 들어갑니다.</span>
						<span>간략한 내용이 들어갑니다.</span>
					</span>
					<span class="li">총 00강</span>
					<span class="li">00개월</span>
					<span class="li">정가 : 000,000원</span>
				</a></li>
			</ul>
			<h3 class="pdt15"><span>중2 내신</span></h3>
			<ul>
				<li><a href="#none">
					<span class="img"><img src="../images/sub/img_course_2.jpg" alt="" /></span>
					<span class="txt">
			...
			<h3 class="pdt15"><span>중3 내신</span></h3>
			<ul>
				<li><a href="#none">
					<span class="img"><img src="../images/sub/img_course_2.jpg" alt="" /></span>
					<span class="txt">
